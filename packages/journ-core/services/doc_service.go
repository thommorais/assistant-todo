...
func NewDocService(repo ports.DocRepository, guard ports.Guard, clock ports.Clock, ids ports.IDGenerator, log ports.Logger) *DocService {
	return &DocService{repo: repo, guard: guard, clock: clock, ids: ids, log: log}
}
