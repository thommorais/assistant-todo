...
export type EmailErrorKey = 'auth_validation_email_required' | 'auth_validation_email_invalid'

export type PasswordErrorKey = 'auth_validation_password_required' | 'auth_validation_password_too_short'

export type NameErrorKey = 'auth_validation_name_required' | 'auth_validation_name_too_short'

export type ConfirmPasswordErrorKey = 'auth_validation_confirm_password_required' | 'auth_validation_passwords_do_not_match'
...
export type LoginFormErrors = {
	readonly email?: EmailErrorKey
	readonly password?: PasswordErrorKey
}
...
export type SignupFormErrors = {
	readonly email?: EmailErrorKey
	readonly password?: PasswordErrorKey
	readonly confirmPassword?: ConfirmPasswordErrorKey
	readonly name?: NameErrorKey
}
